...
- Day 15 | Joint Graph 與 min-cut Partitioner：backward 該存什麼、該重算什麼
- Day 16 | FakeTensor 與 Meta Device：不算數值也能 Trace

## Part 3：TorchInductor

- Day 17 | Inductor 總覽：從 FX Graph 到 Kernel 的路
- Day 18 | Lowering 與 Loop-level IR：圖怎麼變成迴圈
- Day 19 | Scheduler：誰跟誰可以融合
- Day 20 | Fusion 的邊界：垂直、水平與 Reduction
- Day 21 | Triton Codegen：讀懂 Inductor 生出來的 GPU Kernel
- Day 22 | C++ Codegen：CPU 後端與 OpenMP
- Day 23 | Autotune 與 max-autotune：讓機器自己挑 Kernel
- Day 24 | 快取：編譯結果存在哪裡，什麼時候失效

## Part 4：整合與實戰

- Day 25 | CUDA Graph 與 reduce-overhead：壓掉 Kernel 啟動開銷
